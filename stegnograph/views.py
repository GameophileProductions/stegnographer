...
encrypted_image_path = "./encoded.jpeg"


# the path of the encrypted file - used while decrypting
output_decrypted_file = "./Decoded.jpeg"  # this one will remain constant

# similar to encrypted image path but used for encryption output
output_encryped_file = "./encoded.jpeg"  # this one will remain constant
